...
// -- declaration
const addAsepriteEntity = (mgcb,dirName) => { // require .json && .png file
   try {
       ...
       fs.appendFileSync(mgcb,"/importer:TextureImporter\n" +
...
const addAsepriteReferences = (mgcb) => { // todo: hardcoded
    if (!!DEBUG) {
...
const addWindowsConfig = (mgcb) => {
    fs.appendFileSync(mgcb,"/outputDir:bin\n" +
        "/intermediateDir:obj\n" +
        "/platform:Windows\n" +
        "/config:\n" +
        "/profile:Reach\n" +
